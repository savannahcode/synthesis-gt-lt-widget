          ...
          <div className="flex items-center m-1/3 gap-16">
            <div className="flex flex-col items-center gap-12">
              ...
              <div className="flex gap-2">
                <Button onClick={() => setNumSquaresOne((prevNumSquaresOne) => { return prevNumSquaresOne + 1 })}>+</Button>
                <Button onClick={() => setNumSquaresOne((prevNumSquaresOne) => { return prevNumSquaresOne - 1 })}>-</Button>
              </div>
            </div>
            <div className="flex flex-col items-center gap-12">
              ...
              <div className="flex gap-2">
                <Button onClick={() => setNumSquaresTwo((prevNumSquaresTwo) => { return prevNumSquaresTwo + 1 })}>+</Button>
                <Button onClick={() => setNumSquaresTwo((prevNumSquaresTwo) => { return prevNumSquaresTwo - 1 })}>-</Button>
              </div>
            </div>
          </div>
